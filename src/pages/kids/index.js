              ...
              {data.slice(0, 1).map((item, ind) => {
                return (
                  <div  key={ind} className="flex justify-center ">
                    ...
                    <div> 
                    <Image className="w-[100vw] md:w-[50vw] 2xl:w-[30vw] xl:w-[40vw] lg:w-[50vw]"
                        src={item.imageUrl}
                        width={500}
                        height={300}
                        alt={item.title}
                    ...
                    <ul className="bg-green-900 flex h-[7vh] justify-between text-white items-center text-3xl">
                        ...
                        <li><i><FaCartPlus/></i></li></Link>
                        <li><i><FaRegEye/></i></li>
                        <li><i><FaStar/></i></li>
                      </ul>
                    </div>
                    <div className="h-[12vh] text-3xl mt-8">
                      <h5 className="text-3xl sm:text-4xl xs:text-4xl">{item.title} </h5>
                      <p>${item.prize}</p>
                    </div>
                  </div>
                  </div>
...
export async function getStaticProps(){
  const kids= await getAllProducts()
return{
  props:{
      products:kids
  },
